...
Public Class FrmStudent
    ...
    Private Sub academicSave()
        ...
        If subcount = 0 Or selstudscount = 0 Then
            MsgBox("Program Subjects not maintained  or No Student has been selected")
            Exit Sub
        End If

        If Not chkAllExams.Checked Then
        ...
        Else '''All exam for selected class

            cnn = New SqlConnection(ConnectionString)
            cnn.Open()
            trans = cnn.BeginTransaction
            Try
                For Each exm As ComboItem In cboSubExam.Items
                    ...
                    If Not chkAllStuds.Checked Then
                        ...
                        For subbase = 0 To subcount - 1
                            ...
                            param = New SqlParameter("@exam", exm.Text)
                            params.Add(param)

                            param = New SqlParameter("@subExamRef", exm.Value)
                            params.Add(param)
    ...
    Private Sub addMarks()
        ...
        Dim gstrMarkenrolref As String
        gstrstudid = gdStudents.SelectedRows(0).Cells("MarksStudentID").Value
        gstrMarkenrolref = gdStudents.SelectedRows(0).Cells("MarksEnrolRef").Value.ToString
        ...
        Else
            ...
            Try
                ...
                For studbase = 0 To studcount - 2
                    ...
                    type = gvMarks.Rows(studbase).Cells("Type").Value
                    If gvMarks.Rows(studbase).Cells("Check").Value = True Then
                        Dim comment As String = gvMarks.Rows(studbase).Cells("Comment").Value
                        If comment = "" And Not gvMarks.Rows(studbase).Cells("Comment").ReadOnly Then
                        ...
                        If gvMarks.Rows(studbase).Cells("Remarks").Value = "Present" Then
                            If type = "Normal" Then
                                If gvMarks.Columns("CourseMark").Visible Then
                                    Coursemark = gvMarks.Rows(studbase).Cells("CourseMark").Value
                                End If

                                If gvMarks.Columns("ExamMark").Visible Then
                        ...
                        sql = "select * from studentmarks where studentid = '" & gstrstudid & "' and subjectid = '" & subj & "' and exam = '" & cboMarkExam.Text & "'  and status = 1 "

                        Dim drr As SqlDataReader = ExecuteReader(sql, , True)
                        If drr.HasRows Then ' Mark Already exist
                            ...
                            cmd.Parameters.AddWithValue("@examstatus", gvMarks.Rows(studbase).Cells("Remarks").Value)
                            cmd.Parameters.AddWithValue("@subtype", type)
                            cmd.Parameters.AddWithValue("@ref", subref)
                            cmd.Parameters.AddWithValue("@comment", comment)
                            cmd.Parameters.AddWithValue("@enrolref", enrolref)
                            cmd.ExecuteNonQuery()
    ...
    Private Sub gdStudents_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gdStudents.SelectionChanged
        ...
        Try
            ...
            While drr.Read
                ...
                gvMarks.Rows.Add()
                gvMarks.Columns("Comment").Visible = True
                'drr("CommentVisible").ToString
                gvMarks.Rows(row).Cells("Check").Value = True
                gvMarks.Rows(row).Cells("item").Value = row + 1
                gvMarks.Rows(row).Cells("Subject").Value = drr("Subdesc").ToString
                gvMarks.Rows(row).Cells("Type").Value = drr("Type").ToString
                gvMarks.Rows(row).Cells("ExamMark").Value = drr("ExamMark").ToString
                Dim cbocmnt As DataGridViewComboBoxCell = CType(gvMarks.Rows(row).Cells("Comment"), DataGridViewComboBoxCell)
                cbocmnt.Items.Clear()

                For Each cmnt In GetGradeComments(cboMarkProg.Text, gvMarks.Rows(row).Cells("ExamMark").Value)
                    cbocmnt.Items.Add(cmnt)
                Next

                cbocmnt.Value = drr("Comment").ToString
                gvMarks.Rows(row).Cells("Remarks").Value = drr("ExamStatus").ToString
                gvMarks.Rows(row).Cells("CourseMark").Value = drr("CourseMark").ToString
                gvMarks.Rows(row).Cells("Comment").ReadOnly = False

                If drr("MarkFormat") = "ExamMark" Then
                    gvMarks.Columns("CourseMark").Visible = False
                    gvMarks.Columns("ExamMark").Visible = True
                ElseIf drr("MarkFormat") = "TermMark" Then
                    gvMarks.Columns("CourseMark").Visible = True
                    gvMarks.Columns("ExamMark").Visible = False
                ElseIf drr("MarkFormat") = "BothMarks" Then
                    gvMarks.Columns("CourseMark").Visible = True
                    gvMarks.Columns("ExamMark").Visible = True
                Else
                    gvMarks.Columns("CourseMark").Visible = False
                ...
                '          Not CBool(drr("CommentVisible").ToString)
                row += 1
            End While
        ...
        If mblnaddingFess = True Then
            Try
                ...
                For A1 = 0 To rows - 1
                    ...
                    Try
                        reference = dgFessDetails.Rows(A1).Cells("reference").Value
                    Catch ex As Exception
                        reference = "ref"
                    End Try


                    period = dgFessDetails.Rows(A1).Cells("Period").Value
                    Try
                    ...
                    cart = dgFessDetails.Rows(A1).Cells("Cartegory").Value
                    If cart = "" Then
    ...
    Private Sub btnPerfomBilling_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPerfomBilling.Click
        ...
        If cboBillType.Text = "Normal" Then
            ...
            Try
                ...
                Dim ref1 As String = Now.ToShortDateString & " " & Now.TimeOfDay.ToString
                        ...
                        For Each cv In chkBilPeriods.CheckedItems()
                            ...
                            For item2 = 0 To dgPayType.Rows.Count - 1
                                ...
                                If dgPayType.Rows(item2).Selected = True Then
                                    ...
                                    ref = period & "-" & bilcart & "-" & amount & "-" & cboBillingClass.Text & "-" & cboBillingLevel.Text & "" & cboBillingSess.Text & "-" & ref1
    ...
    Private Sub LoadInvoiceReferences()
        ...
        Try
            ...
            While drr.Read
                ...
                chkBilPeriods.Items.Add(drr("Reference"))
    ...
    Private Sub cboBillType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboBillType.SelectedIndexChanged
        ...
        If cboBillType.Text = "Normal" Or cboBillType.Text = "Combined" Then
            btnPerfomBilling.Text = "Perfom Billing"
            chkBilPeriods.Items.Clear()
            ...
            End Try
        ElseIf cboBillType.Text = "Reversal" Then
            btnPerfomBilling.Text = "Reverse Billings"
            '  chkBilPeriods.Items.Clear()
            LoadInvoiceReferences()
    ...
    Private Sub Button28_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClassTeacher.Click
        ...
        If fts.Any Then
            ...
            If gdStudents.SelectedRows.Count > 0 Then
                ...
                Dim FtScreen As New dgFormTeacher()
                FtScreen.FormTeachers = fts
                FtScreen.classstuds = fillAllMarks()
                FtScreen.Exam = cboMarkExam.Text
                FtScreen.studid = gdStudents.SelectedRows(0).Cells(0).Value
    ...
    Private Sub Button29_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHeadComments.Click
    ...
    Private Sub gvMarks_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
    ...
    Private Sub gvMarks_CellValidating(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellValidatingEventArgs) Handles gvMarks.CellValidating
        If gvMarks.Columns(e.ColumnIndex).HeaderText = "TM" Then
            If gvMarks.CurrentRow.Cells(4).Value > 100 Or gvMarks.CurrentRow.Cells(4).Value < 0 Then
                MsgBox("Invalid Course mark")
                e.Cancel = True
                gvMarks.CurrentRow.Cells(4).Value = 0
            Else
                e.Cancel = False
            End If
        ElseIf gvMarks.Columns(e.ColumnIndex).HeaderText = "EM" Then
            If gvMarks.CurrentRow.Cells(5).Value > 100 Or gvMarks.CurrentRow.Cells(5).Value < 0 Then
                MsgBox("Invalid Exam Mark")
                e.Cancel = True
                gvMarks.CurrentRow.Cells(5).Value = 0
            Else
                e.Cancel = False
            End If
        ElseIf gvMarks.Columns(e.ColumnIndex).HeaderText = "Remarks" Then
            If gvMarks.CurrentRow.Cells(7).Value = "" Then
    ...
    Private Sub gvMarks_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles gvMarks.KeyPress
        'If gvMarks.CurrentCell.ColumnIndex = 6 Or gvMarks.CurrentCell.ColumnIndex = 7 Then



        '    If e.KeyChar = ChrW(Keys.Tab) Then
        '        If gvMarks.CurrentRow.Index = gvMarks.Rows.Count - 2 And gvMarks.CurrentCell.ColumnIndex = 7 Then
        '            gvMarks.CurrentCell = gvMarks.Rows(0).Cells(4)

        '        Else
        '            If gvMarks.CurrentCell.ColumnIndex = 6 Then
        '                gvMarks.CurrentCell = gvMarks.CurrentRow.Cells(7)
        '            ElseIf gvMarks.CurrentCell.ColumnIndex = 7 Then
        '                If gvMarks.Rows(gvMarks.CurrentRow.Index + 1).Cells(0).Value = "False" Then
        '                    gvMarks.CurrentCell = gvMarks.Rows(gvMarks.CurrentRow.Index + 1).Cells(4)
        '                ElseIf gvMarks.Rows(gvMarks.CurrentRow.Index + 1).Cells(0).Value = "True" Then
        '                    gvMarks.CurrentCell = gvMarks.Rows(gvMarks.CurrentRow.Index + 1).Cells(4)
        '                End If
        ...
        '        If gvMarks.CurrentCell.ColumnIndex = 6 And gvMarks.CurrentRow.Cells("Check").Value = "True" Then
        ...
        'Else
        '    gvMarks.CurrentCell = gvMarks.CurrentRow.Cells(5)
        'End If
    End Sub
    ...
    Private Sub btnSubClassList_Click(sender As Object, e As EventArgs) Handles btnSubClassList.Click
    ...
    Private Sub dgSubStuds_SelectionChanged(sender As Object, e As EventArgs) Handles dgSubStuds.SelectionChanged, cboSubExam.SelectedIndexChanged
        Dim sql As String
        Dim drr As SqlDataReader
    ...
    Private Sub gvMarks_CellValidated(sender As Object, e As DataGridViewCellEventArgs) Handles gvMarks.CellValidated
        ...
        If e.ColumnIndex = 5 Then
            ...
            cbocmnts = CType(gvMarks.Rows(e.RowIndex).Cells("Comment"), DataGridViewComboBoxCell)
    ...
    Private Sub gvMarks_Validating(sender As Object, e As CancelEventArgs) Handles gvMarks.Validating
    ...
    Private Sub btnBoardingComments_Click(sender As Object, e As EventArgs) Handles btnBoardingComments.Click
    ...
    Private Sub btnSportsComments_Click(sender As Object, e As EventArgs) Handles btnSportsComments.Click
        ...
        If fts.Count > 0 Then
            ...
            If gdStudents.SelectedRows.Count > 0 Then
                ...
                Dim sportsscreen As New DgSportsMaster
                sportsscreen.classstuds = fillAllMarks()
                sportsscreen.Exam = cboMarkExam.Text
                sportsscreen.formteachers = fts
                sportsscreen.studid = gdStudents.SelectedRows(0).Cells(0).Value
