...
Public Class frmEditMarks
        ...
        Try
            ...
            If drr.HasRows Then
                While drr.Read
                    ...
                    dgeditmarks.Rows.Add(cnt, drr("Subject"), drr("Type"), drr("Year"), drr("Sem"), drr("CourseMark"), drr("ExamMark").ToString, drr("FinalMark").ToString, drr("Points").ToString, drr("Decision").ToString, drr("ExamStatus").ToString, drr("Exam").ToString, drr("Comment").ToString, drr("MarkRef").ToString, drr("MarkEnrolRef").ToString)
                    dgeditmarks.Rows(cnt - 1).Cells("Comment").ReadOnly = Not CBool(drr("CommentVisible").ToString)
                End While
            End If
    ...
    Private Sub editmarkrow(ByVal rownumber As Integer)
        ...
        Dim Decision, Exam, ExamStatus, subject, program, comment, studentid, subtype As String
